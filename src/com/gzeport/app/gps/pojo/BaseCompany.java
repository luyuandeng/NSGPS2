...
public class BaseCompany implements   java.io.Serializable {
	...
	public BaseCompany(String companyId, String companyName, Date originateDate, String postCode, String telephone, String fax, String homePage, String engName, Long typeId, String englist,
			...
			String taxRegistrationCode, String maritimeAffairCode, String frontierInspectionCode, String foreignTradeCode, String portOfficeEntryCode, String chinaEportEnterpriseCode,
			String outsideEnterCode, String bussinessScope, String trafficCode, String companyState, String payType, String contactUser, String createCompany, String createUser, Date createDate,
			String areaCode) {
		this.companyId = companyId;
